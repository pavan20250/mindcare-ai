    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mobile-grid-2 gap-6 sm:gap-8">
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-red-800 mb-4">Patient Challenges</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-red-700 text-sm">Long Wait Times</span>
                </div>
                <div className="flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <span className="text-red-700 text-sm">Complex Forms</span>
                </div>
                <div className="flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                  </svg>
                  <span className="text-red-700 text-sm">No Follow-Up</span>
                </div>
              </div>
            </div>
            ...
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-orange-800 mb-4">Clinician Challenges</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-orange-700 text-sm">35% Time on Docs</span>
                </div>
                <div className="flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                  </svg>
                  <span className="text-orange-700 text-sm">Referral Errors</span>
                </div>
                <div className="flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <span className="text-orange-700 text-sm">Billing Issues</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mobile-grid gap-4 sm:gap-6">
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">Intake & Screening</h3>
              <div className="bg-blue-50 rounded-lg p-4 mb-3 aspect-video flex items-center justify-center">
              ...
              <p className="text-gray-600 text-xs">Conversational intake with DSM-5 assessments</p>
            </div>
            
            <div className="card card-hover text-center">
              <div className="feature-icon mb-4 mx-auto bg-gradient-secondary">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">Triage & Referral</h3>
              <div className="bg-green-50 rounded-lg p-4 mb-3 aspect-video flex items-center justify-center">
                <div className="text-center">
              ...
              <p className="text-gray-600 text-xs">Automated routing based on severity</p>
            </div>
            
            <div className="card card-hover text-center">
              <div className="feature-icon mb-4 mx-auto bg-gradient-success">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">AI Clinical Insights</h3>
              <div className="bg-purple-50 rounded-lg p-4 mb-3 aspect-video flex items-center justify-center">
                <div className="text-center">
              ...
              <p className="text-gray-600 text-xs">LLM-powered clinical summaries & plans</p>
            </div>
            
            <div className="card card-hover text-center">
              <div className="feature-icon mb-4 mx-auto bg-gradient-to-r from-purple-600 to-pink-600">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">Smart Dashboards</h3>
              <div className="bg-pink-50 rounded-lg p-4 mb-3 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <svg className="w-12 h-12 text-pink-600 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
                  </svg>
                  <p className="text-xs text-pink-600 font-medium">Real-Time Views</p>
                </div>
              </div>
              <p className="text-gray-600 text-xs">Analytics & appointment tracking</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="relative px-4 sm:px-0">
            ...
            <div className="relative lg:flex lg:flex-row lg:gap-8">
              ...
              <div className="relative z-10 mb-6 lg:mb-0 lg:flex-1">
                <div className="card card-hover text-center">
                  <div className="relative mb-3 sm:mb-4">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
                  ...
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Welcome & Discovery</h3>
                  <div className="bg-blue-50 rounded-lg p-2 sm:p-3 mb-2">
                    <svg className="w-7 h-7 sm:w-8 sm:h-8 text-blue-600 mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                  </div>
                  <p className="text-xs text-gray-600">AI Conversational Intake</p>
                  <p className="text-xs text-blue-600 mt-1 font-medium">Symptom Analyzer</p>
                </div>
              </div>
              ...
              <div className="relative z-10 mb-6 lg:mb-0 lg:flex-1">
                <div className="card card-hover text-center">
                  <div className="relative mb-3 sm:mb-4">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
                  ...
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Conversational Screening</h3>
                  <div className="bg-green-50 rounded-lg p-2 sm:p-3 mb-2">
                    <svg className="w-7 h-7 sm:w-8 sm:h-8 text-green-600 mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                  </div>
                  <p className="text-xs text-gray-600">Intelligent Processing</p>
                  <p className="text-xs text-green-600 mt-1 font-medium">DSM-5 Classification</p>
                </div>
              </div>
              ...
              <div className="relative z-10 lg:flex-1">
                <div className="card card-hover text-center">
                  <div className="relative mb-3 sm:mb-4">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
                  ...
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Treatment & Consultation</h3>
                  <div className="bg-purple-50 rounded-lg p-2 sm:p-3 mb-2">
                    <svg className="w-7 h-7 sm:w-8 sm:h-8 text-purple-600 mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <p className="text-xs text-gray-600">AI-Powered Efficiency</p>
                  <p className="text-xs text-purple-600 mt-1 font-medium">10-15 min → Seconds</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding section-gradient">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mobile-grid-3 gap-4 sm:gap-6">
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-2">Neurodevelopmental</h3>
              <p className="text-gray-600 text-xs mb-2">ASD, ADHD</p>
            ...
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-2">Anxiety Disorders</h3>
              <p className="text-gray-600 text-xs mb-2">GAD, Social, Panic</p>
            ...
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-2">Depressive Disorders</h3>
              <p className="text-gray-600 text-xs mb-2">MDD, Persistent</p>
            ...
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-2">Trauma & Stress</h3>
              <p className="text-gray-600 text-xs mb-2">PTSD</p>
              <p className="text-blue-600 text-xs font-medium">PCL-5</p>
            </div>
            
            <div className="card card-hover text-center">
              <div className="w-14 h-14 bg-yellow-100 rounded-lg flex items-center justify-center mx-auto mb-3">
                <svg className="w-8 h-8 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-2">Substance & Addictive</h3>
              <p className="text-gray-600 text-xs mb-2">Alcohol, Drug Use</p>
            ...
            <div className="card card-hover text-center">
              ...
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-2">Personality Disorders</h3>
              <p className="text-gray-600 text-xs mb-2">BPD</p>
      ...
      <section id="benefits" className="section-padding bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mobile-grid gap-6">
            <div className="card card-hover text-center">
              <div className="mobile-icon-lg bg-gradient-primary rounded-full flex items-center justify-center mx-auto mb-4 shadow-glow">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">Patients</h3>
            ...
            <div className="card card-hover text-center">
              <div className="mobile-icon-lg bg-gradient-success rounded-full flex items-center justify-center mx-auto mb-4 shadow-glow">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">Clinicians</h3>
              <div className="space-y-2">
                <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
            ...
            <div className="card card-hover text-center">
              <div className="mobile-icon-lg bg-gradient-secondary rounded-full flex items-center justify-center mx-auto mb-4 shadow-glow-purple">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">Administrators</h3>
              <div className="space-y-2">
                <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
                  <svg className="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="card card-hover text-center">
              <div className="mobile-icon-lg bg-gradient-to-r from-purple-600 to-pink-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-glow-purple">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="mobile-text-lg font-semibold text-gray-900 mb-3">Organization</h3>
              <div className="space-y-2">
                <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
      ...
      <footer className="bg-gray-900 text-white py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mobile-grid gap-6 sm:gap-8">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-blue-400 mb-4">MindCare AI</h3>
